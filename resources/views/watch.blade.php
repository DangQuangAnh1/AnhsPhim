...
<body>
    ...
    <div class="container">
        ...
        <div class="container70per">
            ...
            <div class="box_movie_big">
                <img src="/storage/images/<?php echo $movie->movie_picture; ?>" alt="" class="movie_picture">
                <i class="fa-solid fa-circle-play"></i>
                <img src="/storage/images/<?php echo $movie->movie_picture; ?>" alt="" class="small_movie_picture">
                <div class="info_movie_picture">
                    <div class="p_movie_name">
                        {{$movie->movie_name}}
                    </div>
                    <div class="box_movie_button">
                        <form action="/watch_trailer/{{$movie->movie_id}}" method="get">
                            <button class="p_play_movie_button">
                                <i class="fa-brands fa-youtube"></i>
                                <div>Trailler</div>
                            </button>
                        </form>
                        <form action="/watch_movie/{{$movie->movie_id}}" method="get">
                            <button class="p_play_movie_button red">
